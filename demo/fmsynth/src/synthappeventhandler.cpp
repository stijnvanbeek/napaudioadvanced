...
namespace nap
{
    SynthAppEventHandler::SynthAppEventHandler(App& app) : AppEventHandler(app)
    {
    ...
    void SynthAppEventHandler::start()
    {
    ...
    void SynthAppEventHandler::process()
    {
        // Poll for events
        SDL_Event event;
        bool quit = false;
...
//                }
    ...
    void SynthAppEventHandler::shutdown()
    {
    ...
    bool SynthAppEventHandler::setTouchGeneratesMouseEvents(bool value)
    {
